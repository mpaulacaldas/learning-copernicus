...
and `conda` to create the virtual environment. 

In my personal computer, I created it using `reticulate`, to make sure I'm 
using the same Python version as for `rgee` (see above).
